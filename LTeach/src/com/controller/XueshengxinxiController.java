...
//	分页查询
	...
	public String xueshengxinxiList(@RequestParam(value="page",required=false)String page,
			ModelMap map,HttpSession session,Xueshengxinxi xueshengxinxi, String yonghuming, String mima, String xingming, String xingbie, String nianji, String dianhua, String zhuzhi, String beizhu, String issh){
	...
	public void quchongXueshengxinxi(Xueshengxinxi xueshengxinxi,HttpServletResponse response){
		   ...
		   map.put("yonghuming", xueshengxinxi.getYonghuming());
		   System.out.println("yonghuming==="+xueshengxinxi.getYonghuming());
		   System.out.println("yonghuming222==="+xueshengxinxiService.quchongXueshengxinxi(map));
