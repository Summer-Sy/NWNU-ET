...
//	分页查询
	...
	public String jiaoshixinxiList(@RequestParam(value="page",required=false)String page,
			ModelMap map,HttpSession session,Jiaoshixinxi jiaoshixinxi, String yonghuming, String mima, String xingming, String xingbie, String touxiang, String zhuanye, String dianhua, String youxiang, String zhuzhi, String beizhu, String issh){
