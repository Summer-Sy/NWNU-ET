...
<table width="950" height="1043" border="0" align="center" cellpadding="0" cellspacing="0" id="__01">
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">  
      <tr>
		 <td width='11%' height=44>用户名：</td><td width='39%'>${jiaoshixinxi.yonghuming}</td><td  rowspan=8 align=center><a href=${jiaoshixinxi.touxiang} target=_blank><img src=${jiaoshixinxi.touxiang}  width=228 height=215 border=0></a></td></tr><tr>
         ...
         <td width='11%' height=44>专业：</td><td width='39%'>${jiaoshixinxi.zhuanye}</td></tr><tr>
         <td width='11%' height=44>电话：</td><td width='39%'>${jiaoshixinxi.dianhua}</td></tr><tr>
         <td width='11%' height=44>邮箱：</td><td width='39%'>${jiaoshixinxi.youxiang}</td></tr><tr>
         <td width='11%' height=44>住址：</td><td width='39%'>${jiaoshixinxi.zhuzhi}</td></tr><tr>
